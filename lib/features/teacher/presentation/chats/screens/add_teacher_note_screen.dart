        ...
        child: Padding(
          ...
          child: Column(
            children: [
              ...
              SizedBox(height: 20),
              CustomFilePicker(label: "Documents", fieldName: "Documents"),
              SizedBox(height: 10),
              CustomDropdown(
              ...
              Consumer<SharedProvider>(
                builder: (context, provider, _) {
                  List<Map<String, dynamic>> classMapList = provider.classNames;
      ...
      floatingActionButton: CommonFloatingActionButton(
        onPressed: () {
          ScaffoldMessenger.of(
            context,
          ).showSnackBar(SnackBar(content: Text("Note Submitted")));
        },
        text: "Send Note",
      ),
    );
